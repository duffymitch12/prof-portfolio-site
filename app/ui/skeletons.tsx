...
export function EducationSkeleton() {
  return (
    ...
    >
      <div className="h-5 w-3/4 bg-gray-200 rounded-md mb-3"></div>{" "}
      {/* Simulated heading */}
  ...
  return (
    <div className="flex flex-col gap-4">
      {[1, 2, 3].map((_, index) => (
        <div
          key={index}
          className={`animate-pulse relative overflow-hidden rounded-xl bg-gray-100 p-6 shadow-sm`}
        >
          <div className="h-5 w-3/4 bg-gray-200 rounded-md mb-3"></div>{" "}
          {/* Simulated job title */}
          ...
          {/* Simulated location */}
          <div className="h-4 w-1/4 bg-gray-200 rounded-md mb-4"></div>{" "}
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      {[1, 2, 3, 4, 5, 6, 7, 8].map((_, index) => (
        <div
          ...
          className={`animate-pulse relative overflow-hidden rounded-xl bg-gray-100 p-6 shadow-sm`}
        >
          <div className="h-4 w-3/4 bg-gray-200 rounded-md mx-auto"></div>{" "}
          {/* Simulated skill */}
        </div>
      ))}
    </div>
