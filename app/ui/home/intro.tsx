...
export default async function Intro() {
    return (
        <>
            <h1 className="hidden md:flex text-xl md:text-3xl font-bold text-nowrap underline underline-offset-8 decoration-[#1A535C] decoration-4">Mitchell Duffy</h1>
            <div className="flex md:mt-10 mt-8 font-light text-gray-600 gap-3 md:text-left ml-10 md:ml-0">
                <div className="pr-4">
