...
export default function SkillsCloud() {
    ...
    skills.forEach((skill) => {
      ...
      do {
        ...
        newSkill = {
          ...
          size:
            Math.random() > 0.6 ? "text-lg md:text-xl" : "text-sm md:text-lg",
        };
        attempts++;
      } while (
        ...
        placedSkills.some((existing) => {
          ...
          return (
            Math.abs(existingTop - newTop) < 10 &&
            Math.abs(existingLeft - newLeft) < 10
          );
  ...
  return (
    <section
      id="skills"
      className="relative w-full h-[450px] md:h-[500px] bg-[#fefefe] pl-8 md:px-0"
    >
      {/* Title */}
