...
export default async function ProjectWrapper() {
  ...
  const parentClass =
    "md:grid md:grid-cols-6 justify-center md:w-5/6 w-full py-8 bg-[#fefefe]";
  ...
  return (
    <>
      <div className="flex flex-col w-full mt-2 md:mt-12 pl-8 mb-0">
        <h2
          className="w-full px-6 mb-6 border-b-4 border-[#277986]  md:border-0 md:text-2xl text-xl  font-semibold text-black md:underline md:underline-offset-[7px] md:decoration-[#277986] md:decoration-4 uppercase md:text-center -indent-4"
          id="projects"
        >
          Projects
        </h2>
