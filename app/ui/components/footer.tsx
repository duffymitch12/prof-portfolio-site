                ...
                <div className="py-6 mx-auto space-y-8 overflow-hidden px-6 lg:px-8">
                    <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                        <div className="flex flex-row px-5 py-2">
                            <a href="mailto:duffymitch12@gmail.com" className="text-base md:leading-6 leading-2 hover:text-[#9DC3C2] text-gray-50">
                                <FontAwesomeIcon icon={['fas', 'envelope']} className="text-2xl mr-2" /> duffymitch12@gmail.com
                            </a>
                        </div>
                        <div className="flex flex-row px-5 py-2">
                            <a href="tel:+12488945884" className="text-base md:leading-6 leading-2 hover:text-[#9DC3C2] text-gray-50">
                                <FontAwesomeIcon icon={['fas', 'phone']} className="text-2xl mr-2" /> (248) 894-5884
                            </a>
                        </div>
                    </nav>
