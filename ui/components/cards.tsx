      ...
      <div className="relative w-full mx-auto mb-4">
        <div className="bg-white shadow-md rounded-lg w-full h-full flex flex-col justify-between dark:bg-gray-800 dark:border-gray-700">
          <div className="relative">
            ...
            {additional && (
              <p className="absolute bottom-0 right-0 bg-brand-navy text-white text-sm pr-3 pl-12 py-1 rounded-tl-2xl">
                {additional}
              </p>
            )}
          </div>
        ...
        {URL && buttonText && !underConstruction && (
          <a
            ...
            className="absolute -inset-1.5 rounded-lg flex items-center hover:underline justify-center bg-gray-200 bg-opacity-60 text-brand-navy text-xl font-semibold opacity-0 hover:opacity-100 transition-opacity duration-300"
          >
            {buttonText}
          </a>
        )}
